...
public class ArticleStatsApi {
  ...
  public ResponseEntity<?> getArticleStats(@PathVariable("slug") String slug) {
    return articleStatisticsQueryService
        ...
        .map(stats -> ResponseEntity.ok(articleStatsResponse(stats)))
  ...
  private Map<String, Object> articleStatsResponse(ArticleStatsData stats) {
    return new HashMap<String, Object>() {
      {
        put("articleStats", stats);
      }
    };
  }
