...
public class CommentDatafetcherTest {
  ...
  private CommentData createCommentData(String id) {
    ...
    return new CommentData(id, "body", "article-id", new DateTime(), new DateTime(), author);
  }
  ...
  void should_get_article_comments_with_first() {
    ...
    CursorPager<CommentData> pager =
        new CursorPager<>(
            Arrays.asList(createCommentData("c1"), createCommentData("c2")), Direction.NEXT, true);
  ...
  void should_get_article_comments_with_cursors() {
    ...
    CursorPager<CommentData> pager =
        new CursorPager<>(Arrays.asList(createCommentData("c1")), Direction.NEXT, false);
    when(commentQueryService.findByArticleIdWithCursor(eq("article-id"), eq(user), any()))
        .thenReturn(pager);
